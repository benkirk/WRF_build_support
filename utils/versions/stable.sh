...
export OPENMPI_VERSION="disabled" #"1.10.4"   # checked versions 1.10.4 -> 4.1.4, versions 2x & 3x seem to required shared libs (see openmpi/build.sh)
export PETSC_VERSION="3.7"
export LIBMESH_VERSION="1.2.1"
